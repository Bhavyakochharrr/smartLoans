  ...
  return (
    <div className="container mt-5 mb-5">
      <div className="card shadow p-4">
        ...
        {/* Loan Amount */}
        <div className="mb-4">
          <label className="form-label fw-bold" style={{ color: "#0D7C66" }}>Loan Amount: ₹{loanAmount}</label>
          <input
            type="range"
            min="100000"
            max="10000000"
        ...
        {/* Interest Rate */}
        <div className="mb-4">
          <label className="form-label fw-bold" style={{ color: "#0D7C66" }}>Interest Rate: {interestRate}%</label>
          <input
            type="range"
            min="1"
            max="20"
        ...
        {/* Loan Tenure */}
        <div className="mb-4">
          <label className="form-label fw-bold" style={{ color: "#0D7C66" }}>Tenure: {loanTenure} months</label>
          <input
            type="range"
            min="12"
            max="240"
